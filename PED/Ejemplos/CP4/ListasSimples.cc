...
void AgregarNodoAlInicio(Nodo*L& cabeza, int valor);
...
int main() {
    ...
    int valorBuscado = 20;
    std::cout << "Buscando el valor " << valorBuscado << ": " 
              << (BuscarValor(cabeza, valorBuscado) ? "Encontrado" : "No encontrado") << std::endl;
