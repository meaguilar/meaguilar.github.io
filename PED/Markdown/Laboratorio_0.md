...
Gitmoji es una convención que utiliza emojis en los mensajes de commit para identificar rápidamente el tipo de cambio realizado.

Puedes consultar la lista completa de emojis en:

- https://gitmoji.dev

#### Gitmojis más utilizados
...
| 🎨 | `:art:` | Mejoras de estructura o formato del código |
| ✅ | `:white_check_mark:` | Agregar o actualizar pruebas |
| 🔥 | `:fire:` | Eliminación de código o archivos |
| 🚀 | `:rocket:` | Despliegue o liberación de versión |
...
```bash
git commit -m ":sparkles: feat: Agregar búsqueda de clientes"
```

```bash
git commit -m ":bug: fix: Corregir validación de correo"
```

**Recomendación:** Combina Gitmoji con Conventional Commits para mantener un historial de cambios más claro y fácil de entender.
